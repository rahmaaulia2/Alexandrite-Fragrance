...
export async function generateMetadata(
    ...
    const product: dataProduct = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/products/${params.slug}`).then((res) => res.json())
                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <p className="leading-relaxed">
                            {data.description} <br /> {data.excerpt}
                        </p>
                        <div className="flex space-x-52 mt-4">
                            ...
                            <Link href="/product">
                                <button className="flex ml-auto text-white bg-gray-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded-2xl">
                                    back
                                </button>
                            </Link>
