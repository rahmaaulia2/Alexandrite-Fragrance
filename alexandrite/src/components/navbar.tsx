        ...
        <div className="antialiased bg-gray-100 dark:bg-gray-900" >
            <div className="w-full text-gray-700 bg-white dark:text-gray-200 dark:bg-gray-800">
                <div className="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
                    ...
                    <nav className={`flex-col flex-grow pb-4 md:pb-0 md:flex md:justify-end md:flex-row ${isMobileMenuOpen ? 'flex' : 'hidden'}`}>
                        <Link
                        ...
                        {/* <div className="relative">
                                ...
                                {isDropdownOpen && (
                                    <div
                                        className="absolute z-50 right-0 w-full md:max-w-screen-sm md:w-screen mt-2 origin-top-right"
                                    >
